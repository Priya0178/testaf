...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data == "close_data":
        ...
        buttons = [[             
            InlineKeyboardButton('🔸ᴄʜᴀɴɴᴇʟ🔸', url='https://t.me/+1AtPM7FXm_pjNDA9'), 
            InlineKeyboardButton('🔸ɢʀᴏᴜᴘ 🔸', url='https://t.me/+38RDOyIpKWkwM2U1') 
            ],[  
            ...
            InlineKeyboardButton('🔗 ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ 🔗', url=f'https://t.me/+Bkirw4kPhlUyZWY0') 
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
